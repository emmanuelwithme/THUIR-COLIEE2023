...
if __name__ == '__main__':
  ...
  # === 讀取正確答案（只取 valid 查詢）===
  rel_dict = rel_file_convert(rel_path, valid_path)

  # === 預測答案設定 ===
  models = {
    "BM25": 'coliee_dataset/task1/lht_process/BM25/output_bm25_valid.tsv',
    "SAILER_en_finetune_by_CSHaitao_Dot": 'coliee_dataset/task1/lht_process/SAILER/output_SAILER_dot_valid.tsv',
    "SAILER_en_finetune_by_CSHaitao_Cos": 'coliee_dataset/task1/lht_process/SAILER/output_SAILER_cos_valid.tsv',
    "moderBert_dot": 'coliee_dataset/task1/lht_process/modernBert/output_modernBert_dot_valid.tsv',
    "moderBert_cos": 'coliee_dataset/task1/lht_process/modernBert/output_modernBert_cos_valid.tsv'
  }
