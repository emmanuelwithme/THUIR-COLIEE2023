...
# ==== 🚀 產生 Train Set 的 JSON ====
bm25_train_path: str = './coliee_dataset/task1/lht_process/BM25/output_bm25_train.tsv'
positive_train_json_path: str = './coliee_dataset/task1/task1_train_labels_2025_train.json'
output_train_json_path: str = './coliee_dataset/task1/lht_process/modernBert/finetune_data/contrastive_bm25_hard_negative_train.json'
...
# ==== 🚀 產生 Valid Set 的 JSON ====
bm25_valid_path: str = './coliee_dataset/task1/lht_process/BM25/output_bm25_valid.tsv'
positive_valid_json_path: str = './coliee_dataset/task1/task1_train_labels_2025_valid.json'
output_valid_json_path: str = './coliee_dataset/task1/lht_process/modernBert/finetune_data/contrastive_bm25_hard_negative_valid.json'
